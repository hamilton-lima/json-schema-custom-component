...
export const POTATO = {
  ...
  layout: [
    { type: 'flex', 'flex-flow': 'row wrap', items: ['name'] },
    {
      key: 'notes',
      type: 'potato',
      listItems: 1,
  ...
  data: {
    first_name: 'Some potato',
    notes: [
      { type: 'personal', text: 'Buy some potatos' },
      { type: 'pet', text: 'Don\'t give potatos to Fido' },
    ]
  },
};

// see https://hamidihamza.com/ajsf/?set=ng-jsf&example=ng-jsf-flex-layout&framework=material-design&language=en
